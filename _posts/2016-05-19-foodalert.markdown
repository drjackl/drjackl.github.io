---
published: true
title: Final Project 1: FoodAlert
layout: post
---
...
**Skills:** MapKit (MKLocalSearch, MKAnnotationView), CoreLocation, UILocalNotification, Key-Value Observing, UISearchBarDelegate, NSXMLParserDelegate, NSCoding, UITableView
